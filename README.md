...
- Data Source: Sumber data mentah/operasional,sistem operasional asli di mana data dibuat dan disimpan
- Gudang data yang sudah dibersihkan dan terintegrasi dari berbagai sumber, dioptimalkan untuk analisis dan pelaporan.
...
-Error karena Perubahan Schema,Terjadi karena struktur tabel berubah.
